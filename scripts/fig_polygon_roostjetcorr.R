# determined jets to plot by looking at correlogram




# need to detrend
#read.csv("data/processed/MonarchJet20042018.csv", row.names = F)
...
png("figures/allmonths_gbifcentroid_jetpos.png",12,9,
